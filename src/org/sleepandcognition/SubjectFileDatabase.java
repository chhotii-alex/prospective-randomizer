...
public class SubjectFileDatabase extends SubjectDatabase {
							...
							if (!field.isEmpty()) {
								if (field.equalsIgnoreCase("committed")) {
									...
									if (tokens.length != 2) {
										...
										Hashtable<String, Double> characteristics = variables.valuesFromKeyValuePair(tokens[0], tokens[1]);
	...
	public void WriteOutSubjects(Hashtable<String, MultiDimSubject> subjectsByID, VariableSet variables) throws IOException {
